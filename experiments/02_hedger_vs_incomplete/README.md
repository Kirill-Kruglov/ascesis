...
Main comparison between arithmetic-mean maximization, geometric-mean bet-hedging, and incomplete preferences.
...
- `results/report.md`
- `results/survival_by_environment.svg`
- `results/run_manifest.json`

The win criterion is held-out only. The list of held-out environments where incomplete preferences strictly beat the hedger may be empty; that is a publishable negative result.
