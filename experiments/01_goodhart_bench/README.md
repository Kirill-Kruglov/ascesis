...
Calibration gridworld for proxy/true reward divergence.
...
- `results/report.md`
- `results/true_reward_vs_pressure.svg`
- `results/run_manifest.json`

Rules: the SPEC is preregistered before publication-grade runs; seeds are fixed; no winner is claimed here; failed separation is published as a bench failure.
